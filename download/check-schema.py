#!/usr/bin/env python3
"""Check and fix schema.prisma on Oracle."""
import paramiko
...
# Check schema
out, _ = run(client, f"grep -n 'defaultSpeed' {REMOTE}/prisma/schema.prisma")
print("Schema has defaultSpeed:", out if out else "NO!")

# Show VoiceVariation model
out, _ = run(client, f"sed -n '/model VoiceVariation/,/^}/p' {REMOTE}/prisma/schema.prisma")
