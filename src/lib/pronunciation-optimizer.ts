...
const STRESS_DICTIONARY: Record<string, string> = {
  ...
  // === FOREIGN / LOANWORDS — pronúncia como brasileiro fala ===
  // Palavras de origem inglesa que o TTS pronuncia com sotaque errado.
  // Inofensivo se o TTS já fala certo — só reforça a pronúncia correta.
  // Redes Sociais
  'youtube': 'iútub',
  'whatsapp': 'uátsap',
  'instagram': 'ínstagran',
  ...
  'cookie': 'cúqui',
  'print': 'prínte',
  'clipboard': 'clípboorde',
  // Cargos e Business
  'marketing': 'márquiti',
  'feedback': 'fídbéque',
  'workshop': 'uórquixópe',
  'deadline': 'dédline',
  'brainstorming': 'bréinstórme',
  'startup': 'stártepe',
  'meeting': 'mítingue',
  'showroom': 'xorrúm',
  'freelancer': 'frísser',
  'business': 'bizinisse',
  'performance': 'perffórmisse',
  'delivery': 'delíveri',
  'branding': 'bréndin',
  'ecommerce': 'ecomérce',
  'sale': 'sséile',
