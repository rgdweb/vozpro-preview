...
echo [2/4] Iniciando OmniVoice Server (porta 7860)... GPU limitada a 85%...
start "OmniVoice GPU" cmd /k "call C:\Users\Administrador\Miniconda3\Scripts\activate.bat && set CUDA_VISIBLE_DEVICES=0 && set PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True,max_split_size_mb:32 && python omnivoice_server.py --ip 0.0.0.0 --port 7860"
