  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      if (useTunnelGenerate) {
        ...
        let tunnelBody: Record<string, unknown> = {
          ...body,
        ...
        // Se tem Locutor Oficial selecionado, SUBSTITUI tunnelBody com payload limpo clone_fast
        if (selectedSpeakerFile) {
          console.log('[F5-TTS] Locutor Oficial (clone_fast):', selectedSpeakerFile)
          tunnelBody = {
            text: String(tunnelBody.text || ''),
            voice_mode: 'clone_fast',
            speaker_id: selectedSpeakerFile,
            guidance_scale: 1.5,
            num_step: 32,
            speed: speed || 1.0,
          }
